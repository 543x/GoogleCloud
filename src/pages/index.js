...
const features = [
    ...
    },
    {
      ...
      description: (
        <>
          CMS creation and publishing inspires unlimited creative possibilities.
        </>
      ),
      denouement: (
        <div className={styles.buttons}>
    ...
    },
    {
     ...
     png: require('@site/static/img/29385237.png').default,
      description: (
        <>
          Avoid vendor lock-in and speed up development with Google Cloud's commitment to open.
        </>
      ),
      denouement: (
        <div className={styles.buttons}>
  ...
  const components = [
    ...
    {
      title: '📊GoogleSheet',
      content: '🔥Online, collaborative spreadsheets.',
      url: 'https://a.z2.pw'
    },
    {
      title: '📰Cms',
      content: '🔥CMS creation and publishing inspires unlimited creative possibilities',
      url: 'https://w.z2.pw'
    },
    {
      title: '✝️ T3 app',
      content: '🔥The best way to start a full-stack, typesafe Next.js app.',
          ...
          <div className="container">
            ...
            <div className={styles.getStarted}>
              <Link
                ...
                to={useBaseUrl('docs/Website%20Navigation')}
              >
                Get Started
              </Link>
            </div>
