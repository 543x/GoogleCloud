...
const config = {
  title: 'GoogleCloud',
  tagline:'High-performance infrastructure for cloud computing, data analytics & machine learning',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/543x/GoogleCloud/edit/main',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: '/docs/Cloud/About%20Kratos', label: 'Cloud', position: 'right'},
          {to: '/docs/coolify/quickstart', label: 'coolify', position: 'right'},
          {to: '/docs/GoogleCloud/java-docs', label: 'GoogleCloud', position: 'right'},
          {to: '/docs/Website%20Navigation', label: 'Website', position: 'right'},
          { href: 'https://www.543x.com', label: 'Help', position: 'right' },
          {
            href: 'https://github.com/543x/GoogleCloud',
            label: 'GitHub',
            position: 'right',
          },
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} GoogleCloud, Inc.`,
      },
